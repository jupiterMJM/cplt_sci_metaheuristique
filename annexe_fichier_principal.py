...
def recuit_simule(T_init, alpha, nom, fonction_transformee, evol_temp, nb_iter, instance, graphe_matrix):
    ...
    score_kept, valide, score_without_punition,  time_axis = evaluation_model(modele_kept, alpha, instance, graphe_matrix)
    ...
    for iteration in tqdm(range(nb_iter)):
        ...
        historique.append(temperature=temperature, proba=proba, score=score, score_without_punition=score_without_punition, valide=valide, time_axis=time_axis, score_kept=score_kept)
